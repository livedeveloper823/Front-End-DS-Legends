...
const Arbitrage = () => {
  ...
  useEffect(() => {
    if (isNotReady) {
      ...
      const interval = setInterval(() => {
        ...
        // Generate random percentage between 0.010 and 0.040
        const randomPercentagePre = Math.random() * (0.040 - 0.010) + 0.010;
        let randomPercentagePost;

        // Ensure that `randomPercentagePost` is different from `randomPercentagePre`
        do {
  ...
  }, [exchangeA, exchangeB, exchanges, isNotReady, price]);
        ...
        <h2 className=" mb-4">ARBITRAGE BOT</h2> */}
          ...
          <div className="pl-4 py-4 rounded  mb-4" style={{ background: '#2D3A56', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
            ...
            <div className="d-flex align-items-center gap-2">
              <p className="fw-bold fund-width" style={{ paddingTop: "10px", }}> Asset:</p>
            ...
            {
              selectedOption !== 'Own Funds' ?
                <p>Please select both options to explore opportunities using data from mempools.</p> :
                <p>Please select and enter both options to explore opportunities using data from mempools.</p>
            }
          ...
          <div className="p-2 p-md-4 rounded mb-4" style={{ background: '#2B2C3B' }}>
            <Table className="overflow-x-auto mb-0" bordered responsive style={{ color: "black" }}>
              ...
              <tbody className="text-white">
                ...
                <tr className="four-line-td-height">
                  {!isNotReady ? <>
                    ...
                    <>
                      <td>Exchange A gas fees (From wallet): 0.000160 BNB <span style={{ color: "yellow" }}>(0.105022 USDT)</span> </td>
                      <td>Exchange B gas fees (From wallet): 0.000160 BNB <span style={{ color: "yellow" }}>(0.105022 USDT)</span></td>
                    </>
                  }
                </tr>
              </tbody>
          ...
          <div className="p-2 p-md-4 rounded  mb-2 " style={{ background: '#2D3A56' }}>
            <Table className="overflow-x-auto mb-0 " bordered responsive style={{ color: "black" }}>
              <tbody className="text-white">
                ...
                <tr>
                  <td className="fw-bold">Bot Service Fees</td>
                  <td style={{ color: "yellow", textAlign: 'right' }}>{
                ...
                >
                  {
                    profit < 0 ? <span>
                      ...
                      Increase the Loan Amount to see more Estimated Profit
                    </span> : ''
                  }
                </p> */}
              </tbody>
          ...
          <button
            disabled={profit < 0}
            style={{ background: 'red', color: 'white' }} onClick={handleShow} className="btn btn-md mx-auto btn-custom mb-2">
            {
              profit < 0 ? 'Increase the Loan Amount to see more Estimated Profit' : 'Click here to make the profit.'
            }
          </button>
